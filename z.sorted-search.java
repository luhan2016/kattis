//https://www.testdome.com/questions/java/sorted-search/24939?visibility=1&skillId=4&orderBy=Difficulty
...
public class SortedSearch {
    ...
    public static void main(String[] args) {
        //System.out.println(SortedSearch.countNumbers(new int[] {5 }, 7)); 
